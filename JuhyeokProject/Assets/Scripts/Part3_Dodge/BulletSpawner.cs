...
public class BulletSpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // PlayerController를 가진 게임 오브젝트를 찾아, 그것의 트랜스폼을 target에 할당.
        // Find 함수는 제네릭 타입을 받아, 해당 타입을 가진 오브젝트를 반환함. 속도가 느리므로 Start나 Awake 등 한 번 실행되는 메소드에서만 사용할 것.
        // FindObjectOfType이 아닌 FindObjectsOfType은 해당 컴포넌트를 가진 오브젝트 모두를 '배열'로 반환함.
